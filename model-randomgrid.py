"""
This pipeline prepare the pipe using make_pipeline and then feed the
RandomizedSearchCV
"""
...
param_grid = {'kneighborsclassifier__n_neighbors': [1, 3, 5, 7, 9, 12, 15, 17, 20, 25],  # noqa
              'kneighborsclassifier__weights': ['distance', 'uniform'],
              'kneighborsclassifier__p': [1, 2, 3, 4, 5]}
grid_search = RandomizedSearchCV(pipe, param_grid, n_iter=20)
